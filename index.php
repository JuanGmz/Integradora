        ...
        <div class="row p-0 m-0">
            ...
            <div class="container p-3 bagr-cafe2">
                ...
                <div class="d-flex justify-content-center p-4">
                    <ul class="nav nav-tabs flex-wrap justify-content-center col-12" id="menuTabs" role="tablist"
                            ...
                            <div class="col-12 col-md-8 d-flex align-items-center">
                                <div class="d-flex flex-wrap w-100 d-flex justify-content-center">
                                    <div class="col-7 col-md-6 p-2 col-sm-6">
                                        <img src="./img/cafes/cafe11.webp" class="card-img-top img-fluid" alt="..."
            ...
            <div class="container-fluid bagr-cafe3 p-3">
                ...
                <div class="row justify-content-center align-items-center d-flex col-12">

                    <div class="col-7 col-sm-6 col-md-3 p-sm-3 d-flex justify-content-center p-3 ">
            ...
            <section class="subscription-section d-flex align-items-center justify-content-center p-2">
                <div class="subscription-content text-center">
                    <h1 class="display-4">Resive grandes <span style="color: #d4a373;">RECOMPENSAS</span> facil</h1>
                    <p class="lead">Mediante asistencia resive grandes recompensas</p>
                    <a href="./html/recompensas.html" class="btn subscription-btn">Echar un vistazo</a>
                </div>
            </section>

            <!-- Blog-->
            <div class=" bagr-cafe2 p-4">
            ...
            <div class="container bagr-cafe1 p-4">
                <div class="col-12 text-center p-2 ">
                    <h1 class="fw-bold text-center" style="letter-spacing: 1px;">Conocenos</h1>
                </div>
                <!-- Carousel -->
