...
select c.id_cliente as cliente,bc.id_bolsa as id_dbc,c.id_carrito as id_carrito,bc.img_url,bc.nombre as producto, dbc.medida, dbc.precio, c.cantidad, c.monto as subtotal 
from carrito c
