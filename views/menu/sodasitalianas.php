    ...
    <div class="container mb-5">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mt-4">
                ...
                <li class="breadcrumb-item active" aria-current="page">Sodas Italianas</li>
            </ol>
        </nav>

        <!-- Titulo -->
        <h1>Sodas Italianas</h1>
        ...
        <div class="row mb-3">
            <?php
                ...
                $query = "CALL listar_productos_menu('Sodas Italianas')";
                    ...
                    echo "
                        <div class='col-6 col-lg-3'>
                            <div class='card border-0'>
                                <img src='../../img/cafes/{$sItaliana->img_url}' class='card-img-top rounded-5' alt='bebidas'>
                                <div class='card-body'>
