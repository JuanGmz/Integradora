            ...
            <div class="col-lg-9 offset-lg-3 p-0">
                ...
                <div class="row p-0 m-0 bg-dark">
                    <div class="row p-3 m-0 shadow-lg">
                        <div class="col-3">
                            <h1 class="text-light fw-bold">Ubicaciones</h1>
                        </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="agregarProductoLabel">Agregar ubicación</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <!-- Aquí va el contenido del modal -->
                                        <div class="modal-body">
                                            <form action="../scripts/admineventos/insertarlugares.php" method="POST" enctype="multipart/form-data">
                                                <!-- Aqui va el formulario -->
                                                <div class="mb-3">
                                                    <label for="nombre" class="form-label">Nombre</label>
                                                    <input type="text" class="form-control" id="nombre" name="nombre" maxlength="60" required placeholder="Nombre de la ubicación">
                                                </div>
                                                <div class="row">
                                                    <div class="col-6 mb-3">
                                                        <label for="descripcion" class="form-label">Ciudad</label>
                                                        <input type="text" class="form-control" id="ciudad" name="ciudad" maxlength="70" required placeholder="Ciudad">
                                                    </div>
                                                    <div class="col-6 mb-3">
                                                        <label for="medida" class="form-label">Estado</label>
                                                        <input type="text" class="form-control" name="estado" maxlength="70" required placeholder="Estado">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="mb-3 col-4">
                                                        <label for="medida" class="form-label">Calle</label>
                                                        <input type="text" class="form-control" id="calle" name="calle" maxlength="100" required placeholder="Calle">
                                                    </div>
                                                    <div class="mb-3 col-4">
                                                        <label for="colonia" class="form-label">Colonia</label>
                                                        <input type="text" min="0" class="form-control" id="colonia" name="colonia" maxlength="80" required placeholder="Colonia">
                                                    </div>
                                                    <div class="mb-3 col-4">
                                                        <label for="codigop" class="form-label">Código Postal</label>
                                                        <input type="text" class="form-control" id="CodigoP" name="CodigoP" maxlength="5" required placeholder="Código Postal">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="descripcion" class="form-label">Descripción</label>
                                                        <textarea type="text" class="form-control" name="descripcion" maxlength="255" required placeholder="Descripción"></textarea>
                                                    </div>
                                                </div>
                                                <div class="text-end">
