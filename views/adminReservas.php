                        ...
                        <form class="row row-cols-lg-auto g-3 align-items-center">
                            <div class="col">
                                <select class="form-select" id="filtrar">
                                    ...
                                    <option value="1">Folio reserva</option>
                ...
                <div class="container-fluid mt-5">
                    <table class="table table-light table-striped text-center" border="1">
                        <thead class="table-dark">
                            <tr>
                                <th scope="col">Folio Reserva</th>
                                <th scope="col">Cliente</th>
                                <th scope="col" class="d-none d-lg-table-cell">Estatus</th>
                                <th scope="col" class="d-none d-lg-table-cell">Fecha Reserva</th>
                                <th scope="col" class="d-none d-lg-table-cell">Evento</th>
                                <th scope="col" class="d-none d-lg-table-cell">Fecha Evento</th>
                        ...
                        <tbody class="table-group-divider">
                            <tr style="line-height: 3;">
                                <th scope="row">1</th>
                                <td>Tobias Gabriel Rodriguez Lujan</td>
                                <td class="d-none d-lg-table-cell">Pendiente</td>
                                <td class="d-none d-lg-table-cell">2024-06-30</td>
                                <td class="d-none d-lg-table-cell">Tributo a Lana del Rey </td>
                                <td class="d-none d-lg-table-cell">2024-07-07</td>
                                <td>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <h5 class="text-start fw-bold mb-3">Aquí irá el folio de la reserva
                                                    </h5>
                                                    <h5 class="text-start fw-bold mb-3">Cliente: <span
                                                            class="fw-normal">Aquí irá el nombre del cliente que realizó
                                                            la reserva</span></h5>
                                                    <h5 class="text-start fw-bold mb-3">Fecha: <span
                                                            class="fw-normal">Aquí irá la fecha en la que se realizó la reserva</span></h5>
                                                    <h5 class="text-start fw-bold mb-3">Estatus: <span
                                                            class="fw-normal">Aquí irá el estatus de la reserva</span></h5>
                                                    <h5 class="text-start fw-bold mb-3">Monto Total: <span
                                                            class="fw-normal">Aquí irá el monto total de la reserva</span>
                                                    </h5>
                                                </div>
                                    ...
                                    <!-- Botón que activa el modal de editar la recompensa -->
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#editarReserva">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </button>
                                    <!-- Modal de editar la recompensa -->
                                    <div class="modal fade" id="editarReserva" tabindex="-1"
                                        aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body text-start">
                                                    <form>
                                                        <div class="mb-3">
                                                            <label for="editarRecompensa" class="form-label">Editar
                                                                Estatus</label>
                                                            <select name="op_adRes" class="form-select"
                                                        ...
                                                        <div class="mb-3">
                                                            <label for="editarImgRecompensa" class="form-label">Adjuntar documento de envio</label>
                                                            <input required type="file" class="form-control"
                                                                id="editarImgRecompensa">
                                                        </div>
                                                        <div class="row">
                                                        </div>
                                                        <div class="mt-3 text-end">
                                                            <button type="button" class="btn btn-primary"
                                                                id="btn-agregar">Guardar Cambios</button>
                                                        </div>
                                                    </form>
                                                </div>
                                                <div class="modal-footer">
