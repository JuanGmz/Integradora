                ...
                <div class='container mt-5'>
                    <div class='row d-flex justify-content-center'>
                        <div class='col-9 col-md-6 col-lg-4 text-sm-center'>
                            <img src='../../img/bolsas/TEXINVER(LAV)T.webp' class='img-fluid rounded coffee-image' alt='Producto'>
                        ...
                        <div class='col-12 col-md-6'>
                            <div class='row text-center'>
                                <div class='col-6'>
                                    <p class='product-detail2 m-0'>Productor y/o Finca:</p>
                                    <p class='product-text fw-bold'>{$bolsacafe[0]->productor_finca}</p>
                                </div>
                                <div class='col-6'>
                                    <p class='product-detail2 m-0'>Proceso:</p>
                                    <p class='product-text fw-bold'>{$bolsacafe[0]->proceso}</p>
                                </div>
                                <div class='col-6'>
                                    <p class='product-detail2 m-0'>Variedad:</p>
                                    <p class='product-text fw-bold'>{$bolsacafe[0]->variedad}</p>
                                </div>
                                <div class='col-6'>
                                    <p class='product-detail2 m-0'>Altura:</p>
